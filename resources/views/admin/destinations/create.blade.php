...
@section('content')
    ...
    <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 2rem; max-width: 1200px;">
        <div class="card">
            ...
            @endif
            <form action="{{ route('admin.destinations.store') }}" method="POST" id="destForm">
                @csrf
                ...
                <div style="margin-bottom: 1rem;">
                    ...
                    <textarea name="description" required rows="3" style="width:100%; padding:0.8rem; border:1px solid #cbd5e1; border-radius:6px;"></textarea>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div style="margin-bottom: 1rem;">
                        ...
                        <select name="environment_status" required style="width:100%; padding:0.8rem; border:1px solid #cbd5e1; border-radius:6px;">
                            <option value="ramah_lingkungan">🟢 Aman / Ramah Lingkungan</option>
                    ...
                    <div style="margin-bottom: 1rem;">
                        ...
                        <input type="text" name="bmkg_adm4" placeholder="Misal: 31.71.03.1001" style="width:100%; padding:0.8rem; border:1px solid #cbd5e1; border-radius:6px;">
                    </div>
                </div>
                ...
                <input type="hidden" name="map_layers_data" id="map_layers_data_input">
