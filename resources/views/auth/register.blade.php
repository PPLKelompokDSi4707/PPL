...
<body>
    <div class="card">
        ...
        <h2 style="text-align: center; margin-bottom: 1.5rem; font-size: 1.3rem;">Buat Akun Wisatawan</h2>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <button type="submit" class="btn">Daftar <i class="fa-solid fa-user-plus"></i></button>
        </form>
        
        <div class="text-center">
            <p style="color: #64748b;">Sudah punya akun? <a href="{{ route('login') }}">Masuk</a></p>
        </div>
    </div>
</body>
</html>
